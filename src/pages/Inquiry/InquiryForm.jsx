        ...
        <div className="w-full max-w-3xl bg-white rounded-lg shadow-md border border-gray-300">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <select
                name="inquiryBy"
                value={formData.inquiryBy}
                onChange={handleChange}
                className="w-full mt-1 p-3 border border-gray-300 rounded-lg"
              >
                <option value="">Select Inquiry By</option>
                <option value="Teena Mam">Teena Mam</option>
                <option value="Sarita Mam">Sarita Mam</option>
                <option value="Charu Mam">Charu Mam</option>
                <option value="Nitin Sir">Nitin Sir</option>
                <option value="Reena Mam">Reena Mam</option>
              </select>
            </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <label className="inline-flex items-center">
                  <input
                    ...
                    checked={
                      formData.productDisplay === "Glass/ Wooden Shelves"
                    }
                    onChange={handleProductDisplayChange}
                    className="form-radio"
                  />
