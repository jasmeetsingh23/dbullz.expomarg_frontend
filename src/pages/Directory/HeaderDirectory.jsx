...
//                 className="px-6 py-3 text-white bg-gradient-to-r from-red-500 to-black rounded-lg hover:bg-gradient-to-r hover:from-yellow-300 hover:to-yellow-600 transition-all duration-300"
//               >
//                 Previous
//               </button>
