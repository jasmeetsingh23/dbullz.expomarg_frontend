    ...
    >
      ...
      >
        <Link to="/view">
          ...
          >
            <FaCube size={28} style={{ marginRight: "10px" }} />
            3D Design Files
          </button>
        </Link>
        ...
        <Link to="/directory">
          <button
            ...
            onMouseLeave={() => setHoveredButton(null)}
          >
            <FaAddressBook size={28} style={{ marginRight: "10px" }} />
            Directory
          </button>
        </Link>
        ...
        <Link to="/proposal">
          <button
            ...
            onMouseLeave={() => setHoveredButton(null)}
          >
            <FaPenFancy size={28} style={{ marginRight: "10px" }} />
            Proposal
          </button>
        </Link>
        <Link to="/Stalldocument">
          <button
            className="font-heading"
            style={{
              ...buttonBaseStyle,
            ...
            onMouseLeave={() => setHoveredButton(null)}
          >
            <IoDocumentTextOutline size={28} style={{ marginRight: "10px" }} />
            Stall Document
          </button>
        </Link>
      </div>
